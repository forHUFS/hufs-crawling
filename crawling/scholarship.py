...
def get_scholarship_data(url = 'http://hufs.ac.kr/user/indexSub.action?codyMenuSeq=37081&siteId=hufs&menuType=T&uId=4&sortChar=AB&linkUrl=04_0203.html&mainFrame=right&dum=dum&boardId=118188197&page=1'):
    driver = WebDriver()
    driver.get(url = url)
